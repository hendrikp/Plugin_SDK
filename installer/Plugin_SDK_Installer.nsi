...
Name "Plugin_SDK for CryEngine 3"

; The file to write
OutFile "Plugin_SDK.exe"

InstallDir "C:\cryengine3_3.4.0\"
...
; Sections
SectionGroup "Binaries" SEC_BIN

    Section "PluginManager.dll" SEC_PLUGINMANAGER
    ...
    Section "Pre-compiled GameDLLs" SEC_CRYGAME
...
SectionGroup  "Developer Tools" SEC_DEV
    ...
    Section "Plugin Wizard 2010" SEC_WIZ
...
!insertmacro MUI_FUNCTION_DESCRIPTION_BEGIN
	!insertmacro MUI_DESCRIPTION_TEXT ${SEC_BIN} "Installs the Binaries needed to use Plugin files."
        !insertmacro MUI_DESCRIPTION_TEXT ${SEC_PLUGINMANAGER} "Installs Plugin_Manager.dll"
        !insertmacro MUI_DESCRIPTION_TEXT ${SEC_CRYGAME} "Installs a pre-compiled GameDLL which already integrates the Pluginmanager. WARNING! This will overwrite any custom GameDLLs that you might've installed before."
	!insertmacro MUI_DESCRIPTION_TEXT ${SEC_DEV} "Installs developer relevant components."
        !insertmacro MUI_DESCRIPTION_TEXT ${SEC_WIZ} "Installs a Wizard for Visual Studio 2010. This will let you easily create new Plugin projects."
